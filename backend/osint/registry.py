...
from backend.osint.adapters.local import AliasVariantAdapter, IocClassifierAdapter, OrgDomainCandidateAdapter, PublicSearchTaskAdapter, WalletValidationAdapter
...
def default_adapters() -> list[OSINTAdapter]:
    return [
        ...
        AliasVariantAdapter(),
        PublicSearchTaskAdapter(),
        OrgDomainCandidateAdapter(),
        WalletValidationAdapter(),
        IocClassifierAdapter(),
    ]
...
def default_transforms() -> list[TransformDefinition]:
    return [
        ...
        TransformDefinition("person_to_alias_variants", "Person -> Alias Variants", "Local alias and username candidate generation; candidate-only until corroborated.", ["person", "full_name", "alias", "name"], ["alias", "username_candidate", "search_query"], "local.alias_variants", source_category="local_native", confidence_profile="candidate_only", noise_risk="medium", evidence_behavior="no_external_evidence;creates_next_actions", output_artifact_class="candidate", recommended_next_transforms=["username_to_profile_candidates"], playbook_id="person_investigation"),
        TransformDefinition("person_to_search_queries", "Person -> Browser Search Queries", "Generate browser-assisted public search tasks for analyst review/import.", ["person", "full_name", "alias", "name"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="no_finding_until_imported_evidence", output_artifact_class="collection_gap", playbook_id="person_investigation"),
        TransformDefinition("alias_to_username_candidates", "Alias -> Username Candidates", "Generate local username candidates from an alias. Candidate-only.", ["alias", "nickname", "full_name"], ["username_candidate"], "local.alias_variants", source_category="local_native", confidence_profile="candidate_only", noise_risk="medium", evidence_behavior="no_external_evidence;candidate_bin", output_artifact_class="candidate", playbook_id="person_investigation"),
        TransformDefinition("username_to_profile_candidates", "Username -> Profile Candidates", "Create browser-assisted profile search tasks; profile evidence must be imported or fetched by supported transforms.", ["username", "handle"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="candidate_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="candidate", recommended_next_transforms=["username_to_profiles"], playbook_id="username_investigation"),
        TransformDefinition("username_to_public_profile_fetch", "Username -> Public Profile Fetch", "Use curated public profile presence checks with false-positive controls.", ["username", "handle"], ["public_profile", "platform", "external_link", "avatar"], "username.public_profiles", source_category="public_passive", confidence_profile="target_marker_required", noise_risk="medium", evidence_behavior="captures_public_profile_evidence", output_artifact_class="candidate_or_entity", recommended_next_transforms=["profile_to_links"], playbook_id="username_investigation"),
        TransformDefinition("username_to_external_links", "Username -> External Link Tasks", "Generate public search tasks for external links declared by a username/profile.", ["username", "public_profile", "profile"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap"),
        TransformDefinition("org_to_domain_candidates", "Organization -> Domain Candidates", "Generate candidate official domains from organization/brand names.", ["organization", "company", "brand"], ["domain_candidate", "search_query"], "local.org_domain_candidates", source_category="local_native", confidence_profile="candidate_only", noise_risk="medium", evidence_behavior="candidate_until_official_evidence", output_artifact_class="candidate", playbook_id="organization_investigation"),
        TransformDefinition("org_to_search_queries", "Organization -> Public Search Queries", "Generate browser-assisted organization registry/document/profile search tasks.", ["organization", "company", "brand"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="organization_investigation"),
        TransformDefinition("brand_to_impersonation_search_queries", "Brand -> Impersonation Search Queries", "Generate browser-assisted brand impersonation and clone-site search tasks.", ["brand", "organization", "company"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="domain_impersonation"),
        TransformDefinition("email_to_syntax_validation", "Email -> Syntax Validation", "Local syntax/domain split; no account existence claim.", ["email"], ["validation", "email_local_part", "domain"], "email.syntax", source_category="local_native", confidence_profile="deterministic_no_account_claim", noise_risk="low", evidence_behavior="derived_from_input", output_artifact_class="signal", playbook_id="email_investigation"),
        TransformDefinition("email_to_public_search_queries", "Email -> Public Search Queries", "Generate browser-assisted exact email search tasks. Does not claim account registration.", ["email"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="email_investigation"),
        TransformDefinition("email_to_code_search_queries", "Email -> Code Search Queries", "Generate public code search tasks; official API remains optional BYOK.", ["email"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap"),
        TransformDefinition("phone_to_search_queries", "Phone -> Public Search Queries", "Generate browser-assisted public document/search tasks without OTP or registration probing.", ["phone"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="phone_investigation"),
        TransformDefinition("wallet_to_format_validation", "Wallet -> Format Validation", "Infer chain and validate public wallet/transaction shapes locally.", ["crypto_wallet", "wallet_address", "tx_hash"], ["validation", "blockchain", "public_explorer_link"], "local.wallet_validation", source_category="local_native", confidence_profile="deterministic_no_attribution", noise_risk="low", evidence_behavior="derived_from_input;browser_task_links", output_artifact_class="signal", playbook_id="crypto_wallet_investigation"),
        TransformDefinition("wallet_to_public_explorer_links", "Wallet -> Public Explorer Links", "Create public explorer review tasks for analyst-assisted blockchain investigation.", ["crypto_wallet", "wallet_address"], ["external_link", "collection_gap"], "local.wallet_validation", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="crypto_wallet_investigation"),
        TransformDefinition("location_to_search_queries", "Location -> Public Search Queries", "Generate public search/map review tasks; evidence must be analyst-imported or official API/BYOK.", ["location", "address", "city", "coordinates", "place"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="location_maps_investigation"),
        TransformDefinition("ioc_to_type", "IOC -> Type Classifier", "Classify IOC shape locally before passive enrichment/import.", ["ioc", "hash", "malware_hash", "url", "domain", "ip"], ["validation"], "local.ioc_classifier", source_category="local_native", confidence_profile="deterministic_no_reputation_claim", noise_risk="low", evidence_behavior="derived_from_input", output_artifact_class="signal", playbook_id="threat_ioc_triage"),
        TransformDefinition("hash_to_search_queries", "Hash -> Public Search Queries", "Generate browser-assisted malware/hash intelligence search tasks.", ["hash", "malware_hash", "sha256", "md5"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="threat_ioc_triage"),
        TransformDefinition("image_to_reverse_search_queries", "Image -> Reverse Search Queries", "Generate browser-assisted reverse image search tasks for analyst-imported results.", ["image_asset", "screenshot", "avatar"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="reverse_image_investigation"),
        TransformDefinition("document_to_entities", "Document -> Entity Extraction Tasks", "Generate local/import task placeholders for document entity extraction; uploaded document remains evidence-first.", ["document", "pdf", "office_document"], ["collection_gap"], "local.public_search_queries", source_category="local_native", confidence_profile="next_action_only", noise_risk="low", evidence_behavior="document_import_required", output_artifact_class="collection_gap", playbook_id="document_intelligence"),
        TransformDefinition("vehicle_to_search_queries", "Vehicle/Asset -> Public Search Queries", "Generate browser-assisted public mention tasks for vehicle/asset identifiers.", ["vehicle", "license_plate_public", "vin_public", "vessel", "aircraft", "asset_tag"], ["search_query", "collection_gap"], "local.public_search_queries", source_category="browser_assisted", confidence_profile="next_action_only", noise_risk="medium", evidence_behavior="browser_task_only", output_artifact_class="collection_gap", playbook_id="vehicle_asset_investigation"),
        TransformDefinition("url_to_metadata", "URL -> Public Metadata", "Use public web fingerprinting for title, headers, and links.", ["url"], ["web_fingerprint", "external_link"], "domain.web_fingerprint", source_category="public_passive", confidence_profile="source_page_evidence", noise_risk="medium", evidence_behavior="captures_http_metadata", output_artifact_class="entity_or_signal"),
        TransformDefinition("url_to_links", "URL -> External Links", "Extract visible public page links through web fingerprinting.", ["url"], ["external_link", "web_fingerprint"], "domain.web_fingerprint", source_category="public_passive", confidence_profile="source_page_evidence", noise_risk="medium", evidence_behavior="captures_http_metadata", output_artifact_class="entity_or_signal"),
        TransformDefinition("image_to_hashes", "Image -> Local Hashes", "Local image hash workflow placeholder; import image evidence first.", ["image_asset", "screenshot"], ["image_hash"], "local.public_search_queries", enabled=False, disabled_reason="local_image_binary_pipeline_not_wired"),
        TransformDefinition("document_to_hashes", "Document -> Local Hashes", "Local document hash workflow placeholder; import document evidence first.", ["document", "pdf", "office_document"], ["hash"], "local.public_search_queries", enabled=False, disabled_reason="local_document_binary_pipeline_not_wired"),
    ]
