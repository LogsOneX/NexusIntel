...
export const FALLBACK_TRANSFORMS: TransformDefinition[] = [
  ...
  { id: "email_to_public_profiles", label: "Email -> Public Profile Pivot", description: "Disabled direct transform. Derive username candidates, promote one, then run Username -> Profiles.", input_types: ["email"], output_types: ["username_candidate", "profile"], adapter_id: "playbook.email_public_profile_pivot", requires_api_key: false, enabled: false, disabled_reason: "Registry unavailable; direct email-to-profile pivot is not implemented" },
  ...
  { id: "domain_to_favicon_hash", label: "Domain -> Favicon Hash", description: "Disabled until the backend registry provides a dedicated favicon hash collector.", input_types: ["domain", "url"], output_types: ["favicon_hash"], adapter_id: "domain.web_fingerprint", requires_api_key: false, enabled: false, passive: true, disabled_reason: "Registry unavailable; favicon hash collector not implemented" },
  ...
  { id: "spiderfoot_csv_import", label: "SpiderFoot CSV Import", description: "Use the production import preview endpoint when the registry is available.", input_types: ["file"], output_types: ["entity"], adapter_id: "importer.spiderfoot_csv", requires_api_key: false, enabled: false, passive: true, disabled_reason: "Registry unavailable; use import preview endpoint" },
];
